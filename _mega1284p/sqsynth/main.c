...
PROGMEM const uint16_t notes[] = {
    ...
    HLD, HLD,
    D_5, HLD, G_5, HLD, D_5, HLD, F_5, HLD, HLD, HLD, D_5, HLD, C_5, HLD, F_4, HLD,
    D_5, HLD, HLD, HLD, HLD, HLD, F_4, HLD, HLD, HLD, HLD, HLD, G_5, HLD,

    D_5, HLD, G_5, HLD, D_5, HLD, F_5, HLD, HLD, HLD, D_5, HLD, F_5, HLD, D_5, HLD,
    D_5, HLD, G_5, HLD, D_5, HLD, F_5, HLD, HLD, HLD, D_5, HLD, F_5, HLD, D_5, HLD,

    D_5, HLD,
    D_5, HLD, G_5, HLD, D_5, HLD, F_5, HLD, HLD, HLD, D_5, HLD, F_5, HLD, D_5, HLD,
    D_5, HLD, G_5, HLD, D_5, HLD, F_5, HLD, HLD, HLD, D_5, HLD, F_5, HLD,
...
/*
PROGMEM const uint16_t notes[] = {
    D_2, HLD, HLD, HLD, D_3, HLD, HLD, HLD, HLD, HLD, HLD, HLD, HLD, HLD, HLD, HLD,
    A_1, HLD, HLD, HLD, HLD, HLD, C_2, HLD, HLD, HLD, HLD, HLD, Db2, HLD, HLD, HLD,

    RST, RST, RST, RST, D_4, HLD, HLD, HLD, A_3, HLD, HLD, HLD, C_4, HLD, HLD, HLD,
    A_3, HLD, HLD, HLD, HLD, HLD, C_4, HLD, HLD, HLD, HLD, HLD, Db4, HLD, HLD, HLD,

    RST, RST, RST, RST, D_7, HLD, RST, RST, RST, RST, RST, RST, D_7, HLD, RST, RST,
    RST, RST, RST, RST, D_7, RST, D_7, RST, RST, RST, RST, RST, D_7, HLD, RST, RST,

    D_6, HLD, G_6, HLD, D_6, HLD, F_6, HLD, HLD, HLD, D_6, HLD, C_6, HLD, F_5, HLD,
    D_6, HLD, HLD, HLD, HLD, HLD, F_5, HLD, HLD, HLD, HLD, HLD, G_6, HLD, HLD, HLD,

    HLD, HLD,
    D_6, HLD, G_6, HLD, D_6, HLD, F_6, HLD, HLD, HLD, D_6, HLD, C_6, HLD, F_5, HLD,
    D_6, HLD, HLD, HLD, HLD, HLD, F_5, HLD, HLD, HLD, HLD, HLD, G_6, HLD,

    D_6, HLD, G_6, HLD, D_6, HLD, F_6, HLD, HLD, HLD, D_6, HLD, F_6, HLD, D_6, HLD,
    D_6, HLD, G_6, HLD, D_6, HLD, F_6, HLD, HLD, HLD, D_6, HLD, F_6, HLD, D_6, HLD,

    D_6, HLD,
    D_6, HLD, G_6, HLD, D_6, HLD, F_6, HLD, HLD, HLD, D_6, HLD, F_6, HLD, D_6, HLD,
    D_6, HLD, G_6, HLD, D_6, HLD, F_6, HLD, HLD, HLD, D_6, HLD, F_6, HLD,
...
// divided by 2 to form a half-amplitude
...
PROGMEM const uint8_t volumes[] = {
    V_100, V_100, V_100, V_50,
    V_50,  V_50,  V_50,  V_100, 
};
...
#define MAX_PATTERN_COUNT  4*(7+2)
